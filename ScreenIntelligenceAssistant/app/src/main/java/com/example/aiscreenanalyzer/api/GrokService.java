...
public class GrokService {
    ...
    private static final String BASE_URL = "https://api.xai.com/v1/chat/completions";
    private static final String MODEL = "grok-2";
    ...
    public void analyzeImage(Bitmap image, String question, AIServiceManager.AnalysisCallback callback) {
        if (apiKey == null || apiKey.isEmpty()) {
            callback.onError("Grok API key not set");
            return;
        }
        ...
        new Thread(() -> {
            try {
                ...
                if (!response.isSuccessful() || responseBody == null) {
                    ...
                    Log.e(TAG, "Grok API error: " + errorMsg);
                ...
                if (jsonResponse.has("choices")) {
                    ...
                    if (choices.length() > 0) {
                        ...
                        callback.onError("No choices in Grok API response");
                    }
                } else {
                    ...
                    if (jsonResponse.has("error")) {
                        ...
                        callback.onError("Invalid response from Grok API");
                    }
                }
